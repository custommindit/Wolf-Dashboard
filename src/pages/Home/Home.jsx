          ...
          <div className="d-flex align-items-center mb-4">
            <div className={styles.image}>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M4.97853 3.09173C4.84271 2.38547 4.22472 1.875 3.50552 1.875H2.25003C1.83582 1.875 1.50003 2.21079 1.50003 2.625C1.50003 3.03921 1.83582 3.375 2.25003 3.375L3.50552 3.375L4.91255 10.6915C5.18418 12.1041 6.42016 13.125 7.85857 13.125H12.5155C13.8783 13.125 15.0699 12.2064 15.4168 10.8885L16.3551 7.32261C16.7306 5.89592 15.6545 4.5 14.1792 4.5H5.24935L4.97853 3.09173ZM5.53781 6L6.38556 10.4083C6.52138 11.1145 7.13936 11.625 7.85857 11.625H12.5155C13.1969 11.625 13.7927 11.1657 13.9661 10.5067L14.9045 6.94087C15.0297 6.46531 14.671 6 14.1792 6H5.53781Z" fill="#667085" />
                <path d="M6.56251 16.125C5.94119 16.125 5.43751 15.6213 5.43751 15C5.43751 14.3787 5.94119 13.875 6.56251 13.875C7.18383 13.875 7.68751 14.3787 7.68751 15C7.68751 15.6213 7.18383 16.125 6.56251 16.125Z" fill="#667085" />
                <path d="M13.125 16.125C12.5037 16.125 12 15.6213 12 15C12 14.3787 12.5037 13.875 13.125 13.875C13.7463 13.875 14.25 14.3787 14.25 15C14.25 15.6213 13.7463 16.125 13.125 16.125Z" fill="#667085" />
              </svg>
            </div>
            <div>
              <p>300K</p>
